...
/*
    Given
        - 테스트 유저 생성, jjwt 라이브러리 이용해서 리프레시 토큰을 만들어
        DB 에 저장, 토큰 생성 API 의 요청 본문에 토큰을 포함하여 요청 객체를 생성
...
/*
    ...
    Chapter09_modified
        ...
        JWT : 토큰 기반 인증 중 현재 인기있는 방식 JSON 형식으로
            ...
            Security Context : 인증 객체가 저장되는 보관소, 인증 정보가 필요할 때 마다
