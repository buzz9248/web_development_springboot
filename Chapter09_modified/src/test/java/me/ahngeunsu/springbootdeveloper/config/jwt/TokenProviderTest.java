...
class TokenProviderTest {
    ...
    void validToken_invalidToken() {
        // given -> 일부러 default 가 아니라 실패하는 token 을 생성하기 때문에 위 메서드와 given 이 다름.
...
/*
    ...
    2.
        ...
        when : 토큰 제공자(tokenProvider) validToken() 메서드를 호출해 유효한 토큰인지 검증한
            결과값을 boolean 값으로 반환
    ...
    4. getUserId()
        ...
        then : 반환받은 유저 ID 가 given 절에서 초기화한 1과 같은지를 확인.
