package me.moonchangbae.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import me.moonchangbae.springbootdeveloper.service.UserDetailService;
...
/*
     1. 스프링 시큐리티의 모든 기능을 사용하지 않게 설정하는 코드
        ...
        h2 데이터를 확인하는 데 사용하는 h2-console 하위 url 을 대상으로 .ignoring() 메서드
    ...
    5. 로그아웃 설정.
        ...
        invalidHttpSession() : 로그아웃 이후에 세션을 전체 삭제할지 여부를 설정 -> 저희는 true 설정
