...
/*
    ...
    AssertJ 로 검증문 가독성 높이기
        ...
        5) starsWith(A) : 접두사가 A 인지 검증
        6) endsWith(A) : 접미사가 A 인지 검증
        7) isEmpty() : 비어있는 값인지 검증
        8) isNotEmpty() : 비어 있지 않은 값인지 검증
        9) isPositive() : 양수인지 검증
        10) isNegative() : 음수인지 검증
        11) isGreaterThan(1) : 1보다 큰 값인지 검출
        12) isLessThan(1) : 1보다 작은 값인지 검출
